...
type ViewMode = 'live' | 'dashboard' | 'history' | 'settings'
...
interface NavbarProps {
    ...
    /** Whether the user can access settings */
                    ...
                    <div className="flex items-center gap-2 text-slate-400 text-xs">
                        ...
                        {canAccessSettings && (
                            <button
                                ...
                                className={`p-1.5 rounded-md transition-colors cursor-pointer ${currentView === 'settings'
